// Shaders inlined as strings to avoid extra loader configuration.
// Mirror of hero.vert.glsl / hero.frag.glsl — keep both in sync.
...
const vec3 COLOR_A = vec3(0.976, 0.451, 0.086);
const vec3 COLOR_B = vec3(0.918, 0.345, 0.047);
const vec3 COLOR_C = vec3(0.984, 0.749, 0.141);
const vec3 BACKGROUND = vec3(0.980, 0.965, 0.945);
